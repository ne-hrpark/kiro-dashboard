            ...
            {loading || !data ? (
              ...
              <>
                ...
                <div className="flex flex-wrap gap-1 mt-1">
                  {data.organization && (
                    <span className="inline-block px-2 py-0.5 rounded-full text-[10px] font-semibold bg-[#9046FF]/20 text-purple-300 border border-[#9046FF]/30">
                      {data.organization}
                    </span>
                  )}
                  {data.department && (
                    <span className="inline-block px-2 py-0.5 rounded-full text-[10px] font-semibold bg-sky-500/20 text-sky-300 border border-sky-500/30">
                      {data.department}
                    </span>
                  )}
                  {data.team && (
