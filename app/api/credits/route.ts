...
import { MOCK_KIRO_USAGE, getMockCreditAnalysis, isMockUsageEnabled } from '@/lib/mock/kiro-usage';
...
export async function GET(req: NextRequest) {
  try {
    ...
    if (isMockUsageEnabled()) {
      ...
      return NextResponse.json(getMockCreditAnalysis(empMap) as CreditAnalysis);
    }
